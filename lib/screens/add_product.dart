...
//     print('from update image widget');
//     var bytes = await File(imagePickedFile!.path).readAsBytes();
//     // var pickedImageSize = bytes.length / 1024;
//     // print('Image size before: ' + pickedImageSize.toString());

//     // int percentage = 10000 ~/ pickedImageSize;
//     // print('percentage: ' + percentage.toString());
//     // File compressedFile = await FlutterNativeImage.compressImage(
//     //     imagePickedFile!.path,
//     //     percentage: percentage);

//     // var compressedImageBytes = await compressedFile.readAsBytes();
//     // var compressedSize = compressedImageBytes.length / 1024;
//     // print('Compressed size: ' + compressedSize.toString());
